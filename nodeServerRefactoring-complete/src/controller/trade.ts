...
// 마켓 코드 한글 검색
export async function wantName(req: Request, res: Response) {
...
//마켓 코드 조회
export async function marketCode(req: Request, res: Response) {
...
// 분 캔들 조회
export async function minuteCandle(req: Request, res: Response) {
...
// 일 캔들 조회
export async function dayCandle(
  req: Request,
  res: Response,
  next: NextFunction
) {
...
// 호가 정보 조회
export async function bidAsk(req: Request, res: Response) {
  const marketCoin = req.body.marketCoin;
