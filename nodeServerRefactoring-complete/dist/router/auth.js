...
router.put('/updatePass', vdUser.validatorUpdatePass, authController.updatePass); // 비밀번호 찾기,변경
router.put('/updateUser', isAuth, vdUser.validatorUpdate, authController.updateUser); // 회원정보수정
router.delete('/resign', isAuth, vdUser.validatorResign, authController.delUser); // 회원 탈퇴
