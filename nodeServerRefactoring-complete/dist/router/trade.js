...
router.post('/minuteCandle', vdTrade.minuteCandle, tradeController.minuteCandle); // 분 캔들 조회
router.post('/dayCandle', isAuth, vdTrade.dayCandle, tradeController.dayCandle); // 일 캔들 조회
router.post('/currentPrice', vdTrade.currentPrice, tradeController.currentPrice); //현재가 정보 조회
